...
\title[\green{An IMBH candidate follow-up in O2 using the BCR}]{\green{A follow-up on intermediate-mass black hole candidates in the second LIGO--Virgo observing run with the Bayes Coherence Ratio}}
