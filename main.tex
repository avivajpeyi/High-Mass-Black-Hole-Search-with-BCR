...
\caption[BCR distribution example]{Histograms represent the survival function (1-CDF) from our high-mass selection of background triggers (gray) and simulated signals (blue) triggers obtained from \pycbc's search of data from $\text{August 13 - 21, 2017}$. Vertical lines mark the $\text{ln}\ \bcr$ of \IAS's GW170817A and \GWTC's GW170814. \avi{Adjust to have same fonts as other plots} }\label{fig:bcrCdf}
\end{figure}
...
\begin{figure*}
    ...
    Right: Posterior probability distributions for some inferred parameters. \avi{Right plot labels being cut off. Should i plot prior-samples on the right? }
    \label{fig:170222}}
\end{figure*}
