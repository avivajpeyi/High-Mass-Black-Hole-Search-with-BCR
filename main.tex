...
% Launch into what Bayesain means 

% mathced-filter searches do not utilise as much information as present
% an optimal search would computer a bayesian odds
% rest of para what a bayesian odds is 
% typicallly Bayesain a follow up tool
% no reason why we cnat use for search
% bayesian search on an entire observing run
