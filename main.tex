...
Our analysis of the \av{double check that these fall in our search space!!} high-mass IAS events and candidates in O2 has resulted in three events with disfavourable $\pastrobcr<0.5$ (GW170202, GW170403, GW170425). On the other hand, five events (GW170121, GW170304, GW170402, GW170727, GW170817A) and one candidate event (170302) reported by IAS have $\pastrobcr>0.5$.

GW170727 and 170302 are of particular interest, with \pastrobcr of 0.94 and 0.73. GW170727 was emitted from a black hole binary system with a source frame total mass $\approx 70\ \msun$. In addition to the high \pastrobcr reported by our study, \citet{IAS1} and \citet{pycbc_ogc_2} have also reported high \pastro values of 0.98 and 0.99, making it a viable gravitational-wave event candidate. Similarly, the sub-marginal-candidate 170302 reported by \cite{IAS1} with a \pastro of 0.45 appears to have a higher significance from our analysis, resulting in a \pastrobcr of $0.73$.  

\av{GW170202's component black holes have source masses (23, 16) below that of our prior space which may be why it has a low \pastrobcr}
...
Although no clear detections are made with the \bcr, a marginal-candidate 170222 has been discovered with a \pastrobcr of $0.53$. This candidate has its similar masses when compared to those of GWTC-1. The other candidates with \pastrobcr
